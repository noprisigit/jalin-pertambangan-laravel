...
@section('content')
    <div class="card mt-3">
        <div class="card-header">
            <h3 class="card-name">{{ __('Form Tambah Produk') }}</h3>
        </div>
        <form method="POST" id="productForm" class="app-form" action="{{ route('admin.products.store') }}"
                    ...
                    <div class="col-12 col-md-8">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" id="name"
                                class="form-control @error('name') is-invalid @enderror" value="{{ old('judul') }}"
                                placeholder="Judul...">
                            @error('judul')

...
@section('title', __('Tambah Artikel'))
...
@section('content')
    <div class="card mt-3">
        <div class="card-header">
            <h3 class="card-title">{{ __('Form Tambah Artikel') }}</h3>
        </div>
        <form method="POST" id="postForm" class="app-form" action="{{ route('admin.posts.store') }}"
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" id="title"
                                class="form-control @error('title') is-invalid @enderror" value="{{ old('judul') }}"
                                placeholder="Judul...">
                            @error('judul')

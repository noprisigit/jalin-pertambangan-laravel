                    ...
                    @foreach ($posts as $post)
                        <div class="blog-wrap shadow mb-70 xs-mb-50">
                            <div class="image-part">
                                <a href="blog-single.html"><img src="{{ $post->thumbnail_url }}"
                                        alt="{{ $post->title }}"></a>
                            </div>
                            <div class="content-part">
                                ...
                                <ul class="blog-meta mb-22">
                                    ...
                                    <li><i class="fa fa-user-o"></i> Dr. Ichwan Azwardi</li>
                                    @if ($post->category)
                                        <li>
                                ...
                                <div class="btn-part">
                                    <a class="readon-arrow" href="blog-single.html">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div id="sticky-sidebar" class="blog-sidebar">
                        ...
                        <div class="sidebar-popular-post sidebar-grid shadow mb-50">
                            <div class="sidebar-title">
                                <h3 class="title semi-bold mb-20">Artikel Terbaru</h3>
                            </div>
                            @foreach ($newestPosts as $post)
                                <div class="single-post mb-20">
                                    ...
                                    <div class="post-desc">
                                        ...
                                        <ul>
                                            <li><i class="fa fa-calendar"></i> {{ $post->created_at->isoFormat('D MMMM Y') }}</li>
                                        </ul>
                                    </div>
                                </div>
                            @endforeach
